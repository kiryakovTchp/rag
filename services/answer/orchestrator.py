...
class AnswerOrchestrator:
    ...
    def generate_answer(
        ...
        cached_result = self.cache.get(tenant_id, query, top_k, rerank, max_ctx_tokens, model)
        if cached_result:
        ...
        messages, remaining_tokens = build_messages(query, reranked_chunks, max_ctx_tokens)
        ...
        # Cache result
        self.cache.set(tenant_id, query, top_k, rerank, max_ctx_tokens, model, answer, citations, usage)
