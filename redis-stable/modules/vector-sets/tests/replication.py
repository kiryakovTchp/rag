            ...
            if use_cas and added_items:
                ...
                try:
                    ...
                    result = self.redis.execute_command(
                        "VADD", self.test_key, "FP32", vec_bytes, item_name, "CAS"
                    )
                ...
                try:
                    # Add without CAS
                    result = self.redis.execute_command(
                        "VADD", self.test_key, "FP32", vec_bytes, item_name
                    )
