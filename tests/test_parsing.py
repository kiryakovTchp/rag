...
class TestParsing(unittest.TestCase):
    ...
    def test_text_continuity_after_parse_and_chunk(self):
        """Test that no text is lost during parse + chunk pipeline."""
        ...
        ## Section 1
        This section contains important information about testing.
        
        ## Section 2
        Another section with more content to test chunking.
        ...
        try:
            # Parse document
            elements = self.office_parser.parse_to_elements(temp_file_path)
