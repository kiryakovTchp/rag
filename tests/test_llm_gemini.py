...
class TestGeminiProvider(unittest.TestCase):
    ...
    def test_generate_success(self):
        ...
        answer, usage = self.provider.generate(
            messages, "gemini-2.5-flash", 100, 0.2, 30
        )
    ...
    def test_generate_api_key_error(self):
        ...
        self.provider.executor.submit.return_value.result.side_effect = Exception(
            "Invalid API key"
        )
    ...
    def test_stream_success(self):
        ...
        self.provider.executor.submit.return_value.result.return_value = [
            mock_chunk1,
            mock_chunk2,
        ]
