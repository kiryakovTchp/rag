...
class TestTablesSimple(unittest.TestCase):
    def setUp(self):
    ...
    def test_table_formatting(self):
        """Test table formatting as markdown."""
        # Test data
        table_data = [["Name", "Age", "City"], ["John", "25", "New York"], ["Jane", "30", "London"]]

        # Format as markdown
        markdown = self.table_parser._format_table_as_markdown(table_data)

        # Check format
        self.assertIn("|Name|Age|City|", markdown)
        self.assertIn("|---|---|---|", markdown)
        self.assertIn("|John|25|New York|", markdown)
        self.assertIn("|Jane|30|London|", markdown)
