...
class TestFeedbackAPI:
    ...
    def test_create_feedback_api_key_user(self, mock_db, mock_auth):
        ...
        # Mock API key user
        api_user = User(id="api_123", tenant_id="test_tenant", email="", role="user")
        ...
        response = client.post(
            "/feedback",
            headers={"Authorization": "Bearer test_token"},
            json={"answer_id": "answer_123", "rating": "up"},
        )
    ...
    def test_get_feedback_for_answer(self, mock_db, mock_auth):
        ...
        response = client.get(
            "/feedback/answer_123", headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_create_feedback_invalid_rating(self):
        ...
        response = client.post(
            "/feedback",
            headers={"Authorization": "Bearer test_token"},
            json={"answer_id": "answer_123", "rating": "invalid_rating"},
        )
...
class TestFeedbackValidation:
    ...
    def test_feedback_create_schema(self):
        ...
        minimal_feedback = FeedbackCreate(answer_id="answer_456", rating="down")
