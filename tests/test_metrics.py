...
from api.metrics import (
    record_token_usage, record_cost, record_cache_hit, record_cache_miss,
    record_rate_limit_exceeded, record_quota_exceeded, update_celery_metrics,
    metrics_endpoint
)
...
class TestMetrics(unittest.TestCase):
    ...
    def test_update_celery_metrics(self):
        ...
        with patch('api.metrics.CELERY_QUEUE_SIZE') as mock_queue_size, \
             patch('api.metrics.CELERY_WORKER_ACTIVE') as mock_worker_active:
    ...
    def test_metrics_endpoint(self, mock_generate_latest):
        ...
        self.assertEqual(response.content, b"# HELP test_metric\n# TYPE test_metric counter\ntest_metric 1.0")
