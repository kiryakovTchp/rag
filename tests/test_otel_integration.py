...
from workers.tracing import get_tracer as get_worker_tracer
from workers.tracing import setup_tracing as setup_worker_tracing
...
class TestOpenTelemetryIntegration:
    ...
    def test_metrics_collection(self):
        ...
        QUERY_LATENCY.labels(route="/test", tenant="test_tenant", method="GET").observe(
            0.5
        )
    ...
    def test_span_creation_overhead(self):
        ...
        with patch("opentelemetry.sdk.trace.TracerProvider") as mock_provider:
            with patch(
                ...
                assert (
                    overhead_ratio < 1.1
                ), f"Tracing overhead too high: {overhead_ratio}"
